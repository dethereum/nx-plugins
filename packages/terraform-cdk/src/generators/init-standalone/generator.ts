...
import { CdktfGeneratorSchema } from './schema';

interface NormalizedSchema extends CdktfGeneratorSchema {
  projectName: string;
  projectRoot: string;
...
export default async function (host: Tree, options: CdktfGeneratorSchema) {
  ...
  addProjectConfiguration(host, normalizedOptions.projectName, {
    ...
    targets: {
      ...
      destroy: {
        executor: '@dethereum/nx-terraform-cdk:destroy',
      },
      synth: {
        executor: '@dethereum/nx-terraform-cdk:synth',
      },
    },
